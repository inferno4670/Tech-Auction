  ...
  return (
    <div className="min-h-screen bg-dark-900 grid-bg flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        <a href="/" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-cyan-400 transition-colors mb-8">
          <ArrowLeft size={16} />
          Back to Home
        </a>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-cyan-400 font-mono mt-1 tracking-wider">ADMIN CONTROL ROOM</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="admin@techquiz.com"
                required
                autoFocus
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-cyan-500 text-dark-900 font-bold text-sm tracking-wider hover:bg-cyan-400 disabled:bg-cyan-500/40 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
        ...
        <p className="text-center text-xs text-slate-600 mt-6 font-mono">Quizmaster access only</p>
      </div>
    </div>
  );
}
